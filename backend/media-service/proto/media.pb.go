...
const file_media_proto_rawDesc = "" +
	...
	"\x0ffinal_media_url\x18\x02 \x01(\tR\rfinalMediaUrl2W\n" +
	"\fMediaService\x12G\n" +
	"\fGetUploadURL\x12\x1a.media.GetUploadURLRequest\x1a\x1b.media.GetUploadURLResponseB-Z+github.com/hoshibmatchi/media-service/protob\x06proto3"
...
var file_media_proto_depIdxs = []int32{
	...
	1, // 1: media.MediaService.GetUploadURL:output_type -> media.GetUploadURLResponse
