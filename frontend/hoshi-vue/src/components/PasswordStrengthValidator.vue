<template>
  <div class="password-validator">
    <div class="validator-item" :class="{ active: hasMinLength }">
      <span class="indicator">✓</span>
      <span class="text">At least 8 characters</span>
    </div>
    <div class="validator-item" :class="{ active: hasUppercase }">
      <span class="indicator">✓</span>
      <span class="text">One uppercase letter</span>
    </div>
    <div class="validator-item" :class="{ active: hasLowercase }">
      <span class="indicator">✓</span>
      <span class="text">One lowercase letter</span>
    </div>
    <div class="validator-item" :class="{ active: hasNumber }">
      <span class="indicator">✓</span>
      <span class="text">One number</span>
    </div>
    <div class="validator-item" :class="{ active: hasSpecialChar }">
      <span class="indicator">✓</span>
